...
class _ProfileRemoteDataSource implements ProfileRemoteDataSource {
  ...
  Future<UpdatePersonalDetailsResponse> updatePersonalDetails(
      UpdatePersonalDetailsRequest request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UpdatePersonalDetailsResponse>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = UpdatePersonalDetailsResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<ProfileModel> getCurrentProfile(Map<String, dynamic> queries) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
