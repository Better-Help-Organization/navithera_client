...
class _ExtraQuestionsDataSource implements ExtraQuestionsDataSource {
  _ExtraQuestionsDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<LanguagesResponse> getLanguages() async {
    ...
    final _options = _setStreamType<LanguagesResponse>(
  ...
  Future<LevelsResponse> getLevel() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LevelsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/level',
  ...
  Future<PreferenceGroupResponse> createPreferenceForGroup(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<PreferenceGroupResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/preference',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PreferenceGroupResponse _value;
    try {
