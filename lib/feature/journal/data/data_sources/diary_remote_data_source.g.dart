...
class _DiaryRemoteDataSource implements DiaryRemoteDataSource {
  _DiaryRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<DiaryListResponse> getDiaryEntries({
    ...
    final _options = _setStreamType<DiaryListResponse>(
  ...
  Future<DiaryCreateResponse> createDiaryEntry(
    ...
    final _options = _setStreamType<DiaryCreateResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DiaryCreateResponse _value;
    try {
  ...
  Future<DiaryEditResponse> updateDiaryEntry(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request);
    final _options = _setStreamType<DiaryEditResponse>(
